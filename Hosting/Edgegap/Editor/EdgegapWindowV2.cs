    ...
    public class EdgegapWindowV2 : EditorWindow
    {
        ...
        private async void OnContainerizeBtnClickAsync()
        {
            ...
            try
            {
                ...
                await EdgegapBuildUtils.RunServerRpc_DockerBuild(
                    dockerfilePath,
        ...
        private async Task GetLocalDockerImagesAsync()
        {
            ...
            await EdgegapBuildUtils.RunServerRpc_DockerImage(
                img =>
                {
        ...
        private async void OnLocalTestDeployClick()
        {
            try
            {
                ...
                await EdgegapBuildUtils.RunServerRpc_DockerRun(img, extraParams);
        ...
        private async void OnLocalTestTerminateCLick()
        {
            try
            {
                ...
                await EdgegapBuildUtils.RunServerRpc_DockerStop();
        ...
        private async void OnUploadImageCreateAppBtnClickAsync()
        {
            try
            {
                ...
                string pushError = await EdgegapBuildUtils.RunServerRpc_DockerPush(
                    _containerRegistryUrl,
                    imageRepo,
                    tag,
