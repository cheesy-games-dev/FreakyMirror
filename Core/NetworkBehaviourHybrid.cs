...
namespace Mirror
{
    public abstract class NetworkBehaviourHybrid : NetworkBehaviour
    {
        ...
        [ServerRpc(channel = Channels.Reliable)] // reliable baseline
        ...
        [ServerRpc(channel = Channels.Unreliable)] // unreliable delta
        ...
        protected virtual void UpdateServerDelta(double localTime)
        {
            ...
            // client updates server in the ServerRpc function(see above), OR,
