...
namespace Mirror.RemoteCalls
{
    ...
    public enum RemoteCallType { ServerRpc, ClientRpc }
    ...
    class Invoker
    {
        // GameObjects might have multiple components of TypeA.ServerRpcA().
    ...
    public static class RemoteProcedureCalls
    {
        ...
        public static void RegisterServerRpc(Type componentType, string functionFullName, RemoteCallDelegate func, bool requiresAuthority) =>
            RegisterDelegate(componentType, functionFullName, RemoteCallType.ServerRpc, func, requiresAuthority);
        ...
        // check if the ServerRpc 'requiresAuthority' which is set in the attribute
        internal static bool ServerRpcRequiresAuthority(ushort cmdHash) =>
            GetInvokerForHash(cmdHash, RemoteCallType.ServerRpc, out Invoker invoker) &&
