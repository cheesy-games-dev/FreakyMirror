    ...
    public class CanvasReferencer : MonoBehaviour
    {
        ...
        public void ButtonGo()
        {
            ...
            if (sceneReferencer && NetworkClient.active)
            {
                ...
                // You could check if prefab (character number) has not changed, and if so just update the sync vars and hooks of current prefab, this would call a ServerRpc from your player.
