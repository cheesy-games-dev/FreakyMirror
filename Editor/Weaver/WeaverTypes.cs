...
namespace Mirror.Weaver
{
    ...
    public class WeaverTypes
    {
        ...
        public MethodReference registerServerRpcReference;
        ...
        public MethodReference sendServerRpcInternal;
        ...
        public WeaverTypes(AssemblyDefinition assembly, Logger Log, ref bool WeavingFailed)
        {
            ...
            sendServerRpcInternal = Resolvers.ResolveMethod(NetworkBehaviourType, assembly, Log, "SendServerRpcInternal", ref WeavingFailed);
            ...
            registerServerRpcReference = Resolvers.ResolveMethod(RemoteProcedureCallsType, assembly, Log, "RegisterServerRpc", ref WeavingFailed);
